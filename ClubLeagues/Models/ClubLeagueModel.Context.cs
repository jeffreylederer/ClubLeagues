...
namespace ClubLeagues.Models
{
    ...
    public partial class LBClubsEntities : DbContext
    {
        public LBClubsEntities()
            : base("name=LBClubsEntities")
        {
        }
        ...
        public virtual ObjectResult<MembershipAllowDelete_Result> MembershipAllowDelete(Nullable<int> clubid)
        {
            var clubidParameter = clubid.HasValue ?
                new ObjectParameter("clubid", clubid) :
                new ObjectParameter("clubid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MembershipAllowDelete_Result>("MembershipAllowDelete", clubidParameter);
        }
        ...
        public virtual int Team_Delete(Nullable<int> idteam)
        {
            var idteamParameter = idteam.HasValue ?
                new ObjectParameter("idteam", idteam) :
                new ObjectParameter("idteam", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Team_Delete", idteamParameter);
        }
