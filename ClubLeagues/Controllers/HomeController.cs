...
namespace ClubLeagues.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var club = _db.Clubs.Find(user.ClubId);
            ViewBag.Error = "";
            var leagues = new List<League>();
            if (User.IsInRole("ClubAdmin"))
            { 
                leagues = _db.Leagues.Where(x=>x.Active && x.ClubId == user.ClubId).ToList();
            }
            else
            {
        ...
        public ActionResult Register(int? id)
        {
            ...
            SetCookie("clubid", club.id);
            SetCookie("clubname", club.Name);
        ...
        public ActionResult Welcome()
        {
            ...
            if (User.IsInRole("Admin"))
                ViewBag.Info = "You are a Application administrator";
            else if (User.IsInRole("ClubAdmin"))
                ViewBag.Info = "You are a Club administrator";
